...
function checkKey(e) {
    ...
    window.location.href = "niveau2.php?a=" + a + "&b=" + b + "&c=" + c + "&d=" + d
}
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="width : 150%;">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary"><a href="niveau3.php">NEXT LEVEL</a></button>
      </div>
    </div>
  </div>
</div>
...
$labyrintheR = array (
  ...
  /*if(!(isset($_SESSION["count"]))){
        $count = 0;
        $labyrintheR[6][1]=3;
        affichage($labyrintheR,$longeur,$largeur,'rouge');
        $labyrintheR[6][1]=0;
      }*/
...
deplacement($_SESSION['labyrinthe'],$longueur,$largeur,$_SESSION['color'],6,1);
...
<form  method="post">
<input type="submit" name="button5" class="case" style="background-color: #fe3547;color: #fe3547;border : 0;position: absolute;bottom: 22%;right: 37%;">
  <input type="submit" name="button6" class="case" style="background-color: #228be6;color: #228be6;border : 0;position: absolute;bottom: 22%;right: 42%;">
</form>

<p style="position:absolute;bottom: 26%;right: 38%;font-size: 150%;">Change color</p>
