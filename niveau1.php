  ...
  <div class="modal-dialog">
    <div class="modal-content" style="width : 150%;">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary"><a href="niveau2.php">NEXT LEVEL</a></button>
      </div>
    </div>
  </div>
</div>
...
function checkKey(e) {
    ...
    window.location.href = "niveau1.php?a=" + a + "&b=" + b + "&c=" + c + "&d=" + d
}
...
deplacement($_SESSION['labyrinthe'],$longueur,$largeur,$_SESSION['color'],5,1);
...
<form  method="post">
<input type="submit" name="button5" class="case" style="background-color: #fe3547;color: #fe3547;border : 0;position: absolute;bottom: 25%;right: 37%;">
  <input type="submit" name="button6" class="case" style="background-color: #228be6;color: #228be6;border : 0;position: absolute;bottom: 25%;right: 42%;">
</form>

<p style="position:absolute;bottom: 30%;right: 38%;font-size: 150%;">Change color</p>
